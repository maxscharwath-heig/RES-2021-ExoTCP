...
public class MultiThreaderServer {
    ...
    final static Logger LOG = Logger.getLogger(MultiThreaderServer.class.getName());
     ...
     */
    public MultiThreaderServer(int port) {
        this.port = port;
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    Logger.getLogger(MultiThreaderServer.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
